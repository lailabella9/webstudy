    ...
    <aside class="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ route('siswa.latihan.index') }}"
                ...
                <i class="bi bi-journal-richtext"></i> Mulai Latihan
            </a>
            <a href="{{ route('siswa.riwayat') }}"
                class="sb-item {{ request()->routeIs('siswa.riwayat') ? 'active' : '' }}">
                <i class="bi bi-bar-chart-fill"></i> Riwayat Nilai
            </a>
            <hr class="sb-divider">
            <a href="{{ route('siswa.profil.edit') }}"
                class="sb-item {{ request()->routeIs('siswa.profil.*') ? 'active' : '' }}">
    ...
    <div class="main-wrap">
        <div class="topbar">
            <div>
                ...
                <p>Selamat datang, <strong>{{ auth()->user()->nama }}</strong> — @yield('page-subtitle', 'Panel siswa WebStudy CBT')</p>
            </div>
