...
@section('topbar-actions')
    <a href="{{ route('guru.dashboard') }}" class="btn-icon-sm"><i class="bi bi-house"></i></a>
@endsection
    ...
    <div style="display:grid; grid-template-columns:320px 1fr; gap:20px; align-items:start;">
        ...
        <div style="display:flex; flex-direction:column; gap:14px;">
                ...
                <div style="padding:0 20px 20px; position:relative;">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:16px;">
                        <div style="background:#f8fafc;border-radius:8px;padding:8px;text-align:center;">
                            <div style="font-size:16px;font-weight:800;color:#1a56db;">{{ $totalMapel }}</div>
                            <div style="font-size:10px;color:#64748b;">Mata Pelajaran</div>
                        </div>
                        <div style="background:#f8fafc;border-radius:8px;padding:8px;text-align:center;">
                            <div style="font-size:16px;font-weight:800;color:#4f46e5;">{{ $totalSoal }}</div>
                            <div style="font-size:10px;color:#64748b;">Soal</div>
                        </div>
                        <div style="background:#f8fafc;border-radius:8px;padding:8px;text-align:center;">
                            <div style="font-size:16px;font-weight:800;color:#0f766e;">{{ $totalSiswa }}</div>
            ...
            <div style="background:#fff; border-radius:14px; border:1px solid #e9edf2; padding:18px 20px;">
                <div
                    style="font-size:12px;font-weight:700;color:#0f172a;text-transform:uppercase;letter-spacing:.06em;margin-bottom:14px;">
                ...
                @forelse($mapels as $m)
                    <div
                        ...
                        <div>
                            <div style="font-size:12.5px;font-weight:600;color:#0f172a;">{{ $m->nama }}</div>
                            <div style="font-size:10.5px;color:#94a3b8;margin-top:1px;">{{ $m->materis_count }} bab ·
                                {{ $m->total_soal }} soal
                            </div>
                        </div>
                    </div>
                @empty
                    <div style="text-align:center;padding:20px;color:#94a3b8;font-size:13px;">
                        <i class="bi bi-journal-x" style="font-size:24px;display:block;margin-bottom:6px;"></i>
                        Belum ada materi
                    </div>
                @endforelse
            </div>
        ...
        <div style="display:flex; flex-direction:column; gap:16px;">
            ...
            <div style="background:#fff; border-radius:14px; border:1px solid #e9edf2; padding:22px 24px;">
                <div
                    ...
                    <i class="bi bi-person-gear" style="color:#1a56db;"></i> Edit Profil Guru
                </div>
