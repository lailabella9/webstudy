...
@section('title', 'Tambah Bab — ' . $mapel->nama)
@section('page-title', 'Tambah Bab Baru')
...
@section('content')
    <div style="max-width:680px;">
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e9edf2;padding:28px;">
            <form method="POST" id="form-tambah-bab" action="{{ route('guru.materi.store', $mapel) }}"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="2"
                        ...
                        onfocus="this.style.borderColor='#1a56db'" onblur="this.style.borderColor='#e2e8f0'"
                        placeholder="Deskripsi singkat tentang bab ini (opsional)">{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div style="font-size:11.5px;color:#94a3b8;margin-bottom:6px;">
                        Tuliskan materi pembelajaran yang akan dipelajari siswa sebelum mengerjakan latihan.
                    </div>
                ...
                <div>
                    ...
                    <div
                        ...
                        <div style="flex:1;">
                            <input type="file" name="file_materi" id="file_materi" accept=".pdf,.doc,.docx,.ppt,.pptx"
                                style="width:100%;font-size:13px;color:#374151;">
                            <div style="font-size:11.5px;color:#94a3b8;margin-top:4px;">
                                Unggah modul atau slide presentasi sebagai referensi siswa
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="width:120px;">
                    ...
                    <input type="number" name="urutan" value="{{ old('urutan', $mapel->materis()->count() + 1) }}"
                        min="0" required
                        style="width:100%;height:44px;border:1.5px solid #e2e8f0;border-radius:9px;
                               padding:0 14px;font-size:13.5px;background:#f8fafc;outline:none;box-sizing:border-box;"
                        onfocus="this.style.borderColor='#1a56db'" onblur="this.style.borderColor='#e2e8f0'">
                ...
                <div style="display:flex;gap:10px;padding-top:4px;border-top:1px solid #f1f5f9;margin-top:4px;">
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg"></i> Simpan Bab
                    </button>
